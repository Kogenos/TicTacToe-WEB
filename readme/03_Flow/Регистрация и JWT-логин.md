...
См. также [JWT-токены (access, refresh)](../05_Implementation/JWT-токены%20(access,%20refresh).md), [Чёрный список refresh-токенов](../05_Implementation/Чёрный%20список%20refresh-токенов.md).
