...
См. также [Схема таблицы games](Схема%20таблицы%20games.md), [Лидерборд](../03_Flow/Лидерборд.md), [История игр пользователя](../03_Flow/История%20игр%20пользователя.md).
