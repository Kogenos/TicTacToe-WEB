...
**Миграции:** Встроены в код через `//go:embed`. При инициализации репозитория выполняются соответствующие SQL-скрипты (см. [Использование embed для SQL](../05_Implementation/Использование%embed%для%SQL.md)).
